...
const props = defineProps(["content", "color", "bgColor", "hideContent"]);

const fgColor = props.color;
...
const hintText = computed(() =>
  props.hideContent ? "Copied!" : `Copied ${props.content}`,
);
</script>
...
.tooltiptext {
  ...
  border: v-bind(fgColor) 1px solid;
}
.clickable {
  cursor: pointer;
}
